    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(5): 
            ...
            Publication.objects.create(
                title=title, abstract=abstract, department=department, category=category, user=user, content=content, archiveFile=archiveFile, archiveAuthors=archiveAuthors, submission=submission
            )
            print(title, department, category, user)  
