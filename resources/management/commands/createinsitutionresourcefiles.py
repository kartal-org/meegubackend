...
from resources.models import ClassroomResource, InstitutionResourceFolder, InstitutionResourceFile
...
INSTITUTIONRESOURCEFOLDER = InstitutionResourceFolder.objects.all()

class Provider(faker.providers.BaseProvider):
    def user(self):
        return self.random_element(USERS)
    
    def institutionresource_folder(self):
        return self.random_element(INSTITUTIONRESOURCEFOLDER)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(5): 
            ...
            resource = fake.institutionresource_folder()

            InstitutionResourceFile.objects.create(
